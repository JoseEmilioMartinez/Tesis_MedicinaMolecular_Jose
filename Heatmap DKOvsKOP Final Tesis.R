...
# Cargar datos
genes_heatmap <- read_excel("D:/Carpetas/Experimentos/Celulas Endoteliales/RNA/RNAseq/Resultados/Analisis Jose 8/DKOvsKOP/Genes Heatmap DKOvsKOP Final.xlsx")
...
salida_png <- file.path(carpeta_salida, "Heatmap_FinalFiltrado_DKOvsKOP_10.png")
salida_pdf <- file.path(carpeta_salida, "Heatmap_FinalFiltrado_DKOvsKOP_10.pdf")
