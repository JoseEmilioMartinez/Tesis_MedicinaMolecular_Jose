...
pca4$Grupo <- factor(pca4$Grupo, 
                     levels = c("STK24 WT STK25 WT", "CCM3 WT", "STK24 KO STK25ECKO", "CCM3ECKO"))
...
p_limpio <- ggplot(pca4, aes(PC1, PC2, fill = Grupo)) +
  ...
  scale_fill_manual(values = colores, 
                    ...
                    name = NULL) +
  labs(title = "PCA CCM3 vs STK24/25",
...
print(p_limpio)
ggsave(file.path(ruta_salida, "PCA_KOPvsDKO_final_4.png"), p_limpio,  width = 9, height = 7, dpi = 400, bg = "white")
